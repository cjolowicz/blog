...
Populate the repository with an initial `README.md`:
...
Add the Read the Docs badge [![Read the
...
Add the documentation link to your `pyproject.toml`:
...
- Build the package on every push to GitLab, for testing.
...
2. **Update the changelog**
    ...
    `CHANGELOG.md` file in your repository, using the format specified at [Keep
