...
be too forgiving when faced with wrong usage. Large data objects can be
generated by test object factories rather than replaced by mock objects (check
out the excellent [factoryboy](https://factoryboy.readthedocs.io/) package).
